...
class PrefixCacheAffinityRouter(
    ...
    async def choose_replicas(
        ...
        if (
            ...
            # Session affinity takes strict priority over prefix cache
            # optimization. The fallback already applied session routing
            # via PowerOfTwoChoicesRequestRouter.choose_replicas.
            return fallback_replicas
        else:
